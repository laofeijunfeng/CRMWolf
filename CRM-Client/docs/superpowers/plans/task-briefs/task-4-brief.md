...
**Interfaces:**
- Consumes: `teamCreateSchema`, `TeamCreateFormValues` from `@/schemas/team-create.schema` (Task 1)
...
See full implementation in plan: CRM-Client/docs/superpowers/plans/2026-07-15-onboarding-v2-migration.md (lines 417-763)
