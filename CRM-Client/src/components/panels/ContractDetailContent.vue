...
/**
 * ContractDetailContent.vue - 可复用合同详情内容组件
 *
    ...
    <SheetHeader class="p-6 pb-4 border-b border-wolf-border-default-v2">
      <Breadcrumb v-if="embedded" class="detail-breadcrumb">
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink as-child>
              <button
                ...
                aria-label="返回客户详情"
                data-testid="contract-detail-back"
                @click="emit('back')"
              >
                客户详情
              </button>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>合同详情</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <SheetFooter class="p-4 border-t border-wolf-border-default-v2 footer-actions">
        ...
        <Button v-if="!embedded" variant="outline" @click="closeSheet">
