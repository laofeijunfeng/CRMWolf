...
<template>
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        aria-label="关闭"
        class="absolute right-4 top-4 size-11 inline-flex items-center justify-center rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary"
      >
