...
<template>
  <div data-testid="config-panel-crm.create_customer" class="grid gap-4">
    ...
    <div class="grid gap-2"><Label for="config-product-public-id">产品对外ID</Label><Input id="config-product-public-id" data-testid="config-product-public-id" :model-value="String(props.config['product_public_id'] ?? '')" @update:model-value="value => update('product_public_id', value)" /></div>
