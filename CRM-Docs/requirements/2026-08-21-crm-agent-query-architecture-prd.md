...
|---|---|
| 文档类型 | PRD |
| 状态 | 目标产品架构已确定；本地实现与 API 验收持续收口，未发布生产 |
| 版本 | v0.4 |
| 日期 | 2026-08-27 |
| 读者 | 产品、研发、测试、实施 |
...
| 版本 | 日期 | 说明 |
|---|---|---|
| v0.4 | 2026-08-27 | 补充上游模型/CRM API 暂时不可用时的用户体验和错误语义：有限重试只发生在模型边界，查询不重放；明确 Query Agent 只读结果、Agent UI 结构化投影和同 Session 多 Turn 隔离。 |
