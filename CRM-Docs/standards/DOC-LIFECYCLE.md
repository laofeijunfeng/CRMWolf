...
| 类型 | 命名格式 | 示例 |
|------|----------|------|
| 需求文档 | `[模块]-REQUIREMENTS.md` | `AI-OPENAPI-REQUIREMENTS.md` |
| 计划文档 | `[模块]-PLAN.md` | `AI-OPENAPI-IMPLEMENTATION-PLAN.md` |
| Changelog | `YYYY-MM-DD-[主题].md` | `2026-06-12-ai-openapi.md` |
...
**版本：1.0 | 创建日期：2026-06-12 | 最后更新：2026-06-12**