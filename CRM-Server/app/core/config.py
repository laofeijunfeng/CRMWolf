...
class Settings(BaseSettings):
    ...
    CUSTOMER_INTELLIGENCE_RECONCILIATION_ENABLED: bool = True
    CUSTOMER_INTELLIGENCE_RECONCILIATION_INTERVAL_SECONDS: int = 300
    CUSTOMER_INTELLIGENCE_RECONCILIATION_BATCH_SIZE: int = 50
    ...
    OUTBOUND_NOTIFICATION_RECOVERY_ENABLED: bool = True
    OUTBOUND_NOTIFICATION_RECOVERY_INTERVAL_SECONDS: int = 15
    OUTBOUND_NOTIFICATION_RECOVERY_BATCH_SIZE: int = 50
    OUTBOUND_NOTIFICATION_MAX_ATTEMPTS: int = 5
    OUTBOUND_NOTIFICATION_RETRY_BASE_SECONDS: int = 15
    OUTBOUND_NOTIFICATION_LEASE_SECONDS: int = 60
    CUSTOMER_ACTIVITY_AI_JOB_RECOVERY_ENABLED: bool = True
    CUSTOMER_ACTIVITY_AI_JOB_RECOVERY_INTERVAL_SECONDS: int = 30
    CUSTOMER_ACTIVITY_AI_JOB_RECOVERY_BATCH_SIZE: int = 20
    CUSTOMER_ACTIVITY_AI_JOB_MAX_ATTEMPTS: int = 5
    CUSTOMER_ACTIVITY_AI_JOB_RETRY_BASE_SECONDS: int = 30
    CUSTOMER_ACTIVITY_AI_JOB_LEASE_SECONDS: int = 300
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_RECOVERY_ENABLED: bool = True
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_RECOVERY_INTERVAL_SECONDS: int = 30
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_RECOVERY_BATCH_SIZE: int = 20
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_MAX_ATTEMPTS: int = 5
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_RETRY_BASE_SECONDS: int = 30
    CUSTOMER_ACTIVITY_SUGGESTION_JOB_LEASE_SECONDS: int = 300
    ...
    AGENT_ROOT_DECISION_TIMEOUT: float = 30.0  # Root 路由结构化请求单次超时(秒)
    AGENT_QUERY_SEMANTIC_TIMEOUT: float = 30.0  # Query 语义解析单次超时(秒)
