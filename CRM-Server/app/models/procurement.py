...
class ProcurementMethod(Base):
    ...
    code = Column(String(50), nullable=False, comment="采购方式编码，如: PUBLIC_BIDDING")
    ...
    __table_args__ = (
        ...
        Index('idx_crm_procurement_methods_team_id', 'team_id'),
        {'comment': '采购方式表'}
    )
...
class ProcurementStageTemplate(Base):
    ...
    支持团队隔离：跟随父表 ProcurementMethod 的 team_id
    """
    ...
    __table_args__ = (
        ...
        Index('idx_crm_procurement_stage_templates_team_id', 'team_id'),
        {'comment': '采购阶段模板表'}
    )
...
class OpportunityStageSnapshot(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_crm_opportunity_stage_snapshots_team_id', 'team_id'),
        {'comment': '商机阶段快照表'}
    )
...
class StageTemplateChangeLog(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_crm_stage_template_change_logs_team_id', 'team_id'),
        {'comment': '阶段模板变更日志表'}
    )
