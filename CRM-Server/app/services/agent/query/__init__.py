...
_EXPORTS: dict[str, str] = {
    ...
    "CRMQueryAuthority": "app.services.agent.query.authority",
    "CRMQueryAuthorityError": "app.services.agent.query.authority",
    ...
    "QueryTemporalIntent": "app.services.agent.query.semantic_intent",
    "LLMQuerySemanticIntentResolver": "app.services.agent.query.semantic_intent",
