...
## 单据类型识别规则（business_type）

根据用户描述识别审批流程适用的单据类型，输出 business_type 字段：
...
{{
  "flow": {{
    "flow_name": "大额回款审批",
    "flow_code": "LARGE_PAYMENT",
    "description": "适用于5万以上回款登记的审批流程",
    "min_amount": 50000,
    "max_amount": null,
    "license_type": null,
    ...
    "nodes": [
      {{
        ...
        "node_order": 1,
        "approve_role": "FINANCE",
        "description": "财务审核回款入账",
        "is_required": 1
      }}
    ]
  }},
  "thinking_process": "用户提及「回款」→ business_type=PAYMENT。金额门槛5万（min_amount=50000）。财务审批对应FINANCE角色。1节点流程。"
}}
```
...
{{
  "flow": {{
    "flow_name": "大额发票审批",
    "flow_code": "LARGE_INVOICE",
    "description": "适用于10万以上发票申请的审批流程",
    "min_amount": 100000,
    "max_amount": null,
    "license_type": null,
    ...
    "nodes": [
      {{
        ...
        "node_order": 1,
        "approve_role": "SALES_DIRECTOR",
        "description": "销售总监审核大额发票",
        "is_required": 1
      }}
    ]
  }},
  "thinking_process": "用户提及「发票」→ business_type=INVOICE。金额门槛10万（min_amount=100000）。总监审批对应SALES_DIRECTOR角色。1节点流程。"
}}
```

用户输入："创建商机审批流程，销售总监审批"
...
{{
  "flow": {{
    "flow_name": "商机审批",
    "flow_code": "OPPORTUNITY_APPROVAL",
    "description": "适用于新建商机的审批流程",
    "min_amount": null,
    "max_amount": null,
    "license_type": null,
    ...
    "nodes": [
      {{
        ...
        "node_order": 1,
        "approve_role": "SALES_DIRECTOR",
        "description": "销售总监审核商机信息",
        "is_required": 1
      }}
    ]
  }},
  "thinking_process": "用户提及「商机」→ business_type=OPPORTUNITY。未设置金额限制，销售总监审批对应SALES_DIRECTOR角色。1节点流程。"
}}
```"""
                ...
                async with client.stream(
                    ...
                    try:
                        ...
                        flow = ApprovalAIParsedFlow(
                            ...
                            # B3：提取单据类型，schema 校验器对缺失/非法值回退 CONTRACT
                            business_type=flow_data.get("business_type") or BusinessType.CONTRACT,
                            nodes=nodes
                        )
