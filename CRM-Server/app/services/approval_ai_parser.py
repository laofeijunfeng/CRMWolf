...
- business_type: 流程适用的单据类型（CONTRACT/PAYMENT/INVOICE，默认 CONTRACT，识别规则见下）
...
4. business_type 必须是 CONTRACT/PAYMENT/INVOICE 之一，不允许其他值
...
{{
  "flow": {{
    ...
    "business_type": "CONTRACT或PAYMENT或INVOICE",
    "nodes": [
      {{
        "node_name": "节点名称",
        "node_code": "节点编码",
